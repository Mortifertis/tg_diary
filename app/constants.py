...
ENTRY_EMPTY_CONTENT_MESSAGE = (
    "Отправьте текст записи, изображение или файл "
    "с поддерживаемым расширением."
)
...
VIEW_SHOW_MORE_PREFIX = "view:page:"
VIEW_ACTION_CALLBACK_PREFIX = "view:action:"
VIEW_ACTION_EXPORT = "export"
VIEW_ACTION_BACKUP = "backup"
VIEW_ACTION_FIND_BY_ID = "find"
VIEW_ACTION_BACK = "back"
BACKUP_SCHEMA_VERSION = "1"
BACKUP_FILE_NAME_TEMPLATE = "backup_{telegram_id}.zip"
BACKUP_DONE_MESSAGE = "Бэкап готов. Сохраните файл для восстановления данных."
